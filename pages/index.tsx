...
type TimestampEvent = {
  ...
  timestamp: string;
  event: "started" | "ended";
  clipType: "action" | "disney" | "lecture";
  clipUrl: string;
};
...
const Home: React.FC = () => {
  ...
  const clips: { url: string; type: "action" | "disney" | "lecture" }[] = [
    { url: "https://www.youtube.com/watch?v=_46AoSnHCRo", type: "action" },
    { url: "https://www.youtube.com/watch?v=uoP3r22Ox_4", type: "disney" },
  ];
